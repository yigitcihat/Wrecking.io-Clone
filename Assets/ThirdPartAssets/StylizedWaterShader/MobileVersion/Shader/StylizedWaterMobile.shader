...
Shader "Marc Sureda/Mobile/StylizedWaterMobile" {
    Properties {
        ...
        _MainFoamOpacity ("MainFoamOpacity", Range(0, 4)) = 1
...
////// Emissive:
                ...
                float3 emissive = (((_MainFoamOpacity*( 1.0 - saturate((sceneZ-partZ)/((0.8*_MainFoamIntensity)+pow((_MainFoamIntensity*node_2913.r),2.0)))))+lerp((_SecondaryFoamOpacity*pow(node_5766.r,2.0)),0.0,saturate((sceneZ-partZ)/_SecondaryFoamIntensity)))+lerp(lerp(lerp(_Color0.rgb,_Color1.rgb,saturate((sceneZ-partZ)/_Gradient1)),_Color2.rgb,saturate((sceneZ-partZ)/_Gradient2)),_FresnelColor.rgb,pow(1.0-max(0,dot(normalDirection, viewDirection)),_FresnelExp)));
